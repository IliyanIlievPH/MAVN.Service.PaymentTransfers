...
using Lykke.Service.PaymentTransfers.Domain.RabbitMq.Handlers;
...
using Lykke.Service.PaymentTransfers.DomainServices.RabbitMq.Handlers;
using Lykke.Service.PaymentTransfers.Services;
